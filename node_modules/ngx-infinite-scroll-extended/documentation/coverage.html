...
<table class="table table-bordered coverage">
    ...
    <tbody>
        <tr class="low">
            <td>
                <a href="./classes/AxisResolver.html">src/services/axis-resolver.ts</a>
            </td>
            <td>
                classe
            </td>
        ...
        <tr class="low">
            <td>
                <a href="./injectables/PositionResolver.html">src/services/position-resolver.ts</a>
            </td>
            <td>
                injectable
            </td>
        ...
        <tr class="low">
            <td>
                <a href="./injectables/ScrollRegister.html">src/services/scroll-register.ts</a>
            </td>
            <td>
                injectable
            </td>
        ...
        <tr class="low">
            <td>
                <a href="./interfaces/IScrollRegisterConfig.html">src/services/scroll-register.ts</a>
            </td>
            <td>
                interface
            </td>
        ...
        <tr class="low">
            <td>
                <a href="./injectables/ScrollResolver.html">src/services/scroll-resolver.ts</a>
            </td>
            <td>
                injectable
            </td>
