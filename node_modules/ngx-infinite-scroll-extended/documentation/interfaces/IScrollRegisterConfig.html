                ...
                <ul class="list">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="../interfaces/IScrollRegisterConfig.html"  class="active" >IScrollRegisterConfig</a>
                                </li>
                        </ul>
                    </li>
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>src/services/scroll-register.ts</code>
        </p>
                ...
                <h3 id="inputs">Properties</h3>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                                ...
                                <tr>
                                    <td class="col-md-4">
                                        <code>filterBefore:     <code>() &#x3D;&gt; boolean</code>
</bcode>
                                    </td>
                                </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                                ...
                                <tr>
                                    <td class="col-md-4">
                                        <code>mergeMap:     <code>Function</code>
</bcode>
                                    </td>
                                </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                                ...
                                <tr>
                                    <td class="col-md-4">
                                        <code>scrollHandler:     <code>(value: any) &#x3D;&gt; void</code>
</bcode>
                                    </td>
                                </tr>
                                    ...
                                    <tr>
                                        <td class="col-md-4">
                                            <i>Type : </i>    <code>(value: any) &#x3D;&gt; void</code>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                                <tr>
                                    <td class="col-md-4">
                                        <b>throttleDuration</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="col-md-4">
                                        <code>throttleDuration:     <code>number</code>
</bcode>
                                    </td>
                                </tr>
    ...
    <div class="tab-pane fade tab-source-code" id="source">
        <pre><code class="hljs javascript">import { ContainerRef, IPositionStats, IScrollStats } from &#x27;../models&#x27;;
