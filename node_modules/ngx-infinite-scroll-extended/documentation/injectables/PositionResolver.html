...
<html class="no-js" lang="">
    <head>
        ...
        <title>ngx-infinite-scroll documentation</title>
    ...
    <body>
        ...
        <div class="navbar navbar-default navbar-fixed-top visible-xs">
            <a href="../" class="navbar-brand">ngx-infinite-scroll documentation</a>
        ...
        <div class="xs-menu menu" id="mobile-menu">
            ...
            <nav>
                ...
                <ul class="list">
                    ...
                    <li class="title">
                        <a href="../">ngx-infinite-scroll documentation</a>
                    </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="../modules/InfiniteScrollModule.html" >InfiniteScrollModule</a>
                                </li>
                        </ul>
                    </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="../classes/AxisResolver.html" >AxisResolver</a>
                                </li>
                        </ul>
                    </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="../injectables/PositionResolver.html"  class="active" >PositionResolver</a>
                                </li>
                                <li class="link">
                                    <a href="../injectables/ScrollRegister.html" >ScrollRegister</a>
                                </li>
                                <li class="link">
                                    <a href="../injectables/ScrollResolver.html" >ScrollResolver</a>
                                </li>
                        </ul>
                    </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="../interfaces/IScrollRegisterConfig.html" >IScrollRegisterConfig</a>
                                </li>
                        </ul>
                    </li>
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>src/services/position-resolver.ts</code>
        </p>
                ...
                <h3 id="methods">Methods</h3>
                    <table class="table table-sm table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-4">
            <code>create(options: IPositionElements)</code>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="col-md-4">
                                        <div class="io-description">
                                            <b>Returns: </b>    <code>IResolver</code>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-4">
            <code>defineContainer(windowElement: any, isContainerWindow: boolean)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-4">
            <code>isElementWindow(windowElement: any)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <b> getDocumentElement</b>
                                </td>
                            </tr>
            
                            <tr>
                                <td class="col-md-4">
            <code>getDocumentElement(isContainerWindow: boolean, windowElement: any)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-4">
            <code>calculatePoints(element: <a href="https://angular.io/docs/ts/latest/api/core/index/ElementRef-class.html" target="_blank" >ElementRef</a>, resolver: IResolver)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <b> calculatePointsForWindow</b>
                                </td>
                            </tr>
            
                            <tr>
                                <td class="col-md-4">
            <code>calculatePointsForWindow(element: <a href="https://angular.io/docs/ts/latest/api/core/index/ElementRef-class.html" target="_blank" >ElementRef</a>, resolver: IResolver)</code>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="col-md-4">
                                        <div class="io-description">
                                            <b>Returns: </b>    <code>IPositionStats</code>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <b> calculatePointsForElement</b>
                                </td>
                            </tr>
            
                            <tr>
                                <td class="col-md-4">
            <code>calculatePointsForElement(element: <a href="https://angular.io/docs/ts/latest/api/core/index/ElementRef-class.html" target="_blank" >ElementRef</a>, resolver: IResolver)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <b><span class="modifier">Private</span> height</b>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    ...
                                    <code>height(elem: any, isWindow: boolean, offsetHeightKey: string, clientHeightKey: string)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <b><span class="modifier">Private</span> offsetTop</b>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    ...
                                    <code>offsetTop(elem: any, axis: <a href="../classes/AxisResolver.html" >AxisResolver</a>, isWindow: boolean)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <b><span class="modifier">Private</span> pageYOffset</b>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    ...
                                    <code>pageYOffset(elem: any, axis: <a href="../classes/AxisResolver.html" >AxisResolver</a>, isWindow: boolean)</code>
                                </td>
                            </tr>
    ...
    <div class="tab-pane fade tab-source-code" id="source">
        <pre><code class="hljs javascript">import { Injectable, ElementRef } from &#x27;@angular/core&#x27;;
