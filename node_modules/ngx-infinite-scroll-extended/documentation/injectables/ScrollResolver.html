                ...
                <ul class="list">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="../injectables/PositionResolver.html" >PositionResolver</a>
                                </li>
                                <li class="link">
                                    <a href="../injectables/ScrollRegister.html" >ScrollRegister</a>
                                </li>
                                <li class="link">
                                    <a href="../injectables/ScrollResolver.html"  class="active" >ScrollResolver</a>
                                </li>
                        </ul>
                    </li>
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>src/services/scroll-resolver.ts</code>
        </p>
                ...
                <h3 id="methods">Methods</h3>
                    <table class="table table-sm table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-4">
            <code>shouldScroll(container: IPositionStats, config: IScrollerConfig, scrollingDown: boolean)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-4">
            <code>isScrollingDown(container: IPositionStats)</code>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-4">
            <code>getScrollStats(container: IPositionStats, config: IScrollerConfig)</code>
                                </td>
                            </tr>
                ...
                <h3 id="inputs">Properties</h3>
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <b><span class="modifier">Public</span> lastScrollPosition</b>
                                </td>
                            </tr>
                            <tr>
                                <td class="col-md-4">
                                    <span class="modifier-icon fa fa-circle"></span><code>lastScrollPosition:     <code>number</code>
            </bcode>
                                </td>
                            </tr>
                                <tr>
    ...
    <div class="tab-pane fade tab-source-code" id="source">
        <pre><code class="hljs javascript">import { IPositionStats, IScrollerConfig } from &#x27;../models&#x27;;
