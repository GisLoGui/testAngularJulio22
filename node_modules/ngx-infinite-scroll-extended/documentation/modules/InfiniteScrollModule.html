                ...
                <ul class="list">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in"
                            ...
                            >
                                <li class="link">
                                    <a href="../modules/InfiniteScrollModule.html"  class="active" >InfiniteScrollModule</a>
                                </li>
                        </ul>
                    </li>
...
<ol class="breadcrumb">
  <li>Modules</li>
  <li>InfiniteScrollModule</li>
</ol>

<div class="text-center">
    <object id="demo-svg" type="image/svg+xml" data="../modules/InfiniteScrollModule/dependencies.svg" style="width: 100%; height: 250px;">
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="infos">
        ...
        <p class="comment">
            <code>src/modules/ngx-infinite-scroll.module.ts</code>
        </p>
